    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (cookies != null) {
            ...
            if (Username != null && Password != null) {
                httpReq.getRequestDispatcher("home.jsp").forward(request, response);
                return;
            }
        }
        ...
        if (!url.contains("login.jsp")) {
            ...
            if (Username != null && Password != null) {
                if (Username.length() < 5 || Password.length() < 5) {
                    httpReq.setAttribute("message", "username or password must contain at least 5 characters!");
                    httpReq.getRequestDispatcher("login.jsp").forward(request, response);
                    return;
                }
            } else {
                httpReq.setAttribute("message", "You must login to see more!");
                httpReq.getRequestDispatcher("login.jsp").forward(request, response);
                return;
            }
        }
