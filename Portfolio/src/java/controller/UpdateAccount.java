...
public class UpdateAccount extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String idString = request.getParameter("idAcc");
        int idAcc = Integer.parseInt(idString);
        ...
        Account eAccount = new Account(idAcc,username, password, isAdmin);

        DBContext db = new DBContext();
        db.updateAccount(eAccount);
        
        request.setAttribute("successU", "Update successfully!");
        request.getRequestDispatcher("AccountServlet").forward(request, response);
    }
