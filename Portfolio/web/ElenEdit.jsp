        ...
        <main>
            <form id="form" method="POST" action="UpdateCrudServlet?idPD=${idPD}">
                ...
                <div id="home">
                    ...
                    <h3>Hello, I'm</h3>
                    <input id="inputName" value="${name}" type="text" name="name" placeholder="Your Name" required> *<br><br>
                    ...
                    <br>
                    <br>
                    <input id="inputDes" type="text" ${des} name="des" placeholder="Describe about yourself...">
                </div>
