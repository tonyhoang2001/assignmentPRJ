...
<html>
    ...
    <body>
            ...
            <div class="paging">
                ...
                <div class="paging-container">
                    <div class="paging-two">
                        <div class="paging-portfolio row" id="see-portf" title="Click to see more">
                            <!-- avatar -->
        ...
        <script>
            const seePortf = document.getElementById("see-portf")
            seePortf.addEventListener("click", function () {
